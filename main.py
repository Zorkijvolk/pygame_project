...
class Player(pygame.sprite.Sprite):
    ...
    def interaction(self):
        global key1, key2, first_player_duplicate, second_player_duplicate, final1, final2
        if self.player == 1:
...
def start_game():
    ...
    while running:
        ...
        if pause and not (final2 and final1):
            fpause()
